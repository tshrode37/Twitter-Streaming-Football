...
if __name__ == '__main__':    
    ...
    game_2_tags = ["Josh Allen", "Patrick Mahomes", "Buffalo Bills", "Kansas City Chiefs", 
                   "Superbowl", "ChiefsKingdom", "ChiefsvsBills", "AFC Championship",
                   "SuperbowlLV", "BillsMafia", "NFLPlayoffs"] #Buffalo Bills, Kansas City Chiefs

    
    twitterstream.filter(track=game_2_tags, languages=["en"]) #[8]
